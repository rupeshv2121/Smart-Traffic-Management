...
function mod(
  ...
  return { key, seg, path: `/dashboard/${seg}`, label, labelHi, roles, built };
}
...
export const MODULES: ModuleDef[] = [
  mod("command", "command", "Command Dashboard", "कमांड डैशबोर्ड", ALL_ROLES, true),
  ...
  mod("signal", "signal", "Signal Control", "सिग्नल नियंत्रण", ["ADMIN", "OPERATOR"], true),
  mod("challan", "challan", "Challan Review", "चालान समीक्षा", ["ADMIN", "INSPECTOR"], true),
  mod("ti", "ti", "Corridor Inspector", "गलियारा निरीक्षक", ["ADMIN", "INSPECTOR"], true),
